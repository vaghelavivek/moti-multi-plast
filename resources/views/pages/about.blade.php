...
@section('body')
    <section>
                ...
                <div class="absolute w-full h-full rounded-3xl top-0 left-0 bg-[#00000080] grid place-items-center">
                    <div>
                        <h1 class="text-center text-white font-semibold md:text-4xl text-xl" data-aos="zoom-in-up">Moti Multi
                            Plast</h1>
                        <h2 class="text-center text-white font-semibold md:text-base text-[12px]" data-aos="zoom-in-up">Company
                            Profile</h2>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4 md:mb-16 my-10">
            ...
            <p class="md:text-xl text-lg uppercase text-gray-700 font-semibold border-gray-700 border-l-4 pl-3 mb-6 mt-20">
                Our Market</p>
            ...
            <p class="md:text-xl text-lg uppercase text-gray-700 font-semibold border-gray-700 border-l-4 pl-3 mb-6 mt-16">
                Quality Control</p>
