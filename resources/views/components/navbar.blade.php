<header class="bg-white z-50">
    <nav class="container px-4 mx-auto md:grid flex justify-between grid-cols-3 gap-2 py-2 max-w-screen-xl">
        <div class="flex gap-1.5 items-center">
            ...
            <a href="tel:8045802802" class="sm:text-sm text-[12px] font-medium text-primary">+8045 802 802</a>
        </div>
        ...
        <div class="flex items-center justify-end md:gap-2 gap-1">
            <a href="https://wa.me/9898989978?text=Hello! My interest is on plastic containers for packaging. The item you sell on your website https://milanindia.com" target="_blank"
