<header class="bg-white z-50">
    <nav class="container px-4 mx-auto grid grid-cols-3 gap-2 py-2 max-w-screen-xl">
                    ...
                    <li>
                        @if (Route::current()->getName() == 'landing.about')
                            <p class="text-base text-primary font-semibold">Company
                                Profile</p>
                        @else
                            <a href="{{ route('landing.about') }}" class="text-base text-gray-500 font-semibold">Company
                                Profile</a>
                        @endif
                    </li>
                    <li>
